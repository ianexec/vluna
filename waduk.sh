...
print_success() {
    echo -e "${OK} ${GREEN}$1 berhasil diproses${NC}"
}
...
function XRAY_SETUP() {
    clear
    print_install "Menginstall Xray Core Versi 1.8.1 (Latest)"
...
function PW_DEFAULT() {
    ...
    local password_url="https://raw.githubusercontent.com/ianexec/vluna/main/configure/password"
...
function LIMIT_HANDLER() {
    clear
    print_install "Memasang Service Limit Quota"

    # Download dan jalankan install.sh untuk setup awal
    wget https://raw.githubusercontent.com/ianexec/vluna/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh
